...
class my_task():
    ...
    def run(self):
        ...
        while (1):
            ...
            if self.period % 5 != 0 and self.name == "pump1":
                return
            if self.period % 5 != 0 and self.name == "pump2":
                return
            if self.period % 5 != 0 and self.name == "machine1":
                return
            if self.period % 5 != 0 and self.name == "machine2":
                return
